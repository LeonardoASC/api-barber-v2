...
class StoreHorarioPersonalizadoRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'data_inicial' => ['required', 'date', Rule::unique('horario_personalizados', 'data_inicial')],
            'data_final' => ['required', 'date', 'after:data_inicial', Rule::unique('horario_personalizados', 'data_final')],
